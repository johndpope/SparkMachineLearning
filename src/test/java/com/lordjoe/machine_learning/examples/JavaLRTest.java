...
//            return new LabeledPoint(y, Vectors.dense(x));
    ...
    public static final String DEFAULT_FILE = "data/mllib/lr-data/random.data";

    @Test
    public void testLR() throws Exception {
        doLogicalRegression(DEFAULT_FILE, DEFAULT_ITERATIONS, DEFAULT_STEP);
    }

    public static void doLogicalRegression(String inFile, int iterations, double stepSize) {
        SparkUtilities.setAppName("LRTest");
        JavaSparkContext sc = SparkUtilities.getCurrentContext();


        JavaRDD<String> lines = sc.textFile(inFile);
    ...
    public static void main(String[] args) {
        ...
        doLogicalRegression(args[0], iterations, stepSize);
        //sc.stop();
    }
}
