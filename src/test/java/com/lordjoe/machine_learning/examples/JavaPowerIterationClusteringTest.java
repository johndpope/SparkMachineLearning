 ...
 */
public class JavaPowerIterationClusteringTest {
  @Test
  public void testPowerIterationClustering() {
    SparkUtilities.setAppName("JavaPowerIterationClusteringExample");
    JavaSparkContext  jsc = SparkUtilities.getCurrentContext();


    @SuppressWarnings("unchecked")
    JavaRDD<Tuple3<Long, Long, Double>> similarities = jsc.parallelize(Lists.newArrayList(
