...
public class JavaRandomForestClassificationTest {

  @Test
  public void testRandomForestClassification() {
    SparkUtilities.setAppName("JavaRandomForestClassificationExample");
    ...
    Double testErr =
      1.0 * predictionAndLabel.filter(new DoNotEqual()).count() / testData.count();
    System.out.println("Test Error: " + testErr);
    System.out.println("Learned classification forest model:\n" + model.toDebugString());

    // Save and load model
    SparkUtilities.saveModel(model, "target/tmp/myRandomForestClassificationModel");
  ...
  private static class DoNotEqual implements Function<Tuple2<Double, Double>, Boolean> ,Serializable {
    @Override
