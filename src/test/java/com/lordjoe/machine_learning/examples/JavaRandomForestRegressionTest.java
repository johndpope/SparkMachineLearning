...
public class JavaRandomForestRegressionTest {

  @Test
  public void testRandomForestRegression() {
    SparkUtilities.setAppName("JavaRandomForestRegressionExample");
    ...
    Double testMSE =
      predictionAndLabel.map(new Distance()).reduce(new DoubleDoubleDoubleFunction2()) / testData.count();
    System.out.println("Test Mean Squared Error: " + testMSE);
    System.out.println("Learned regression forest model:\n" + model.toDebugString());

    // Save and load model
    SparkUtilities.saveModel(model,  "target/tmp/myRandomForestRegressionModel");
  ...
  private static class Distance implements Function<Tuple2<Double, Double>, Double> {
    @Override
