...
public class SparkUtilities implements Serializable {
    ...
    private  static JavaSparkContext threadContext;
     ...
     * @return
     */
    public static boolean expunge(String src ) {
        FileSystem hadoopFileSystem = SparkUtilities.getHadoopFileSystem();
        return expunge(new Path(src),hadoopFileSystem);
    }
    ...
    public static void saveModel(Saveable model, String pathname) {
        SparkUtilities.expunge(pathname);
        // Save and load model
        SparkContext sc = SparkUtilities.getCurrentSparkContext();
    ...
    /**
     * return an open OutputStream to a file of this name
     *
    ...
    OutputStream getHadoopOutputStream(@Nonnull String fileName) {
        ...
        Path path = getRelativePath(fileName);
        try {
...
//    }
    ...
    public static SparkContext getCurrentSparkContext()
    {
        return JavaSparkContext.toSparkContext( getCurrentContext());
    }
